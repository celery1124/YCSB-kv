...
public class KVrangedbClient extends DB {
  ...
  public void init() throws DBException {
    synchronized(KVrangedbClient.class) {
      if(client == null) {
        batchSize = Integer.parseInt(getProperties().getProperty(PROPERTY_BATCH_SIZE));
        hintScanLen = Boolean.parseBoolean(getProperties().getProperty(PROPERTY_HINT_SCAN_LEN));
